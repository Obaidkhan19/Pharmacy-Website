...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <body>
        ...
        <div style="color: black; padding-top:133px; padding-bottom:148px; padding-left:610px; padding-right:100px">
            <p>OBAID PHARMACY IS AN INNOVATIONAL IDEA OF WEB BASED DATABASE INTERNATIONAL PROJECT. IT INCLUDES SOLUTION OF EVERY KIND OF MAJOR AND MINOR ISSUES.THIS PROJECT INCLUDE PARTICIPATION OF THREE GROUP MEMBERS:: </p>
            <p>1. Obaid Khan </p>
            <p>2. Zaeem Rasheed </p>
            <p>3. Sheriyar Khan</p>
            <p></p>
            <p></p>
            <p>FOR ANY QUERIES AND SUGGESTIONS, KINDLY CONTACT US AT "OBAID@GMAIL.COM" </p>
            <p></p>
            <p></p>
        </div>
    </body>
